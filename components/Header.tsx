...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-[100] w-full border-b border-gray-800 bg-gray-900/95 backdrop-blur supports-[backdrop-filter]:bg-gray-900/90">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="flex lg:hidden">
          <button
            type="button"
            className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-300 relative z-[101]"
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden">
          ...
          />
          <div className="fixed inset-y-0 right-0 z-[201] w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-800">
